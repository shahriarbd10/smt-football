...
const SpecialEventSchema = new Schema(
  {
    ...
    formationPlayers: {
      ...
      default: [
        { id: "gk-1-nayeem", name: "Nayeem", role: "GK", designation: "Goalkeeper", x: 9, y: 50, imageUrl: "" },
        { id: "gk-2-omar", name: "Omar", role: "GK", designation: "Goalkeeper", x: 14, y: 50, imageUrl: "" },
        { id: "cb-1-rakib", name: "Rakib", role: "CB", designation: "Center Back", x: 24, y: 20, imageUrl: "" },
        { id: "cb-2-fahim", name: "Fahim", role: "CB", designation: "Center Back", x: 24, y: 40, imageUrl: "" },
        { id: "cb-3-hasib", name: "Hasib", role: "CB", designation: "Center Back", x: 24, y: 60, imageUrl: "" },
        { id: "cb-4-polas", name: "Polas", role: "CB", designation: "Center Back", x: 24, y: 80, imageUrl: "" },
        { id: "cmf-1-shahriar", name: "Shahriar", role: "CMF", designation: "Central Midfielder", x: 48, y: 28, imageUrl: "" },
        { id: "cmf-2-mynul", name: "Mynul", role: "CMF", designation: "Central Midfielder", x: 48, y: 50, imageUrl: "" },
        { id: "cmf-3-sanim", name: "Sanim", role: "CMF", designation: "Central Midfielder", x: 48, y: 72, imageUrl: "" },
        { id: "cf-1-jamil", name: "Jamil", role: "CF", designation: "Center Forward", x: 72, y: 32, imageUrl: "" },
        { id: "cf-2-imtiaz", name: "Imtiaz", role: "CF", designation: "Center Forward", x: 72, y: 50, imageUrl: "" },
        { id: "cf-3-israk", name: "Israk", role: "CF", designation: "Center Forward", x: 72, y: 68, imageUrl: "" },
      ],
    },
  },
  { _id: false },
